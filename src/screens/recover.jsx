...
export const Recover = () =>{
  ...
  return(
    ...
    <div className="bg-white-50 flex flex-col items-center p-12 gap-y-8 rounded-md max-md:w-[75%] max-md:px-4 max-md:py-8 max-h-[90%] overflow-y-scroll shadow-white-900 shadow-3xl">
        ...
        <button type="submit" className="mt-2 w-full bg-blue-ribbon-600 font-bold text-white-50 px-2 py-2 rounded-md text-lg hover:bg-blue-ribbon-700 flex flex-row items-center justify-center gap-x-2 max-md:text-base">Enviar coóigo</button>
