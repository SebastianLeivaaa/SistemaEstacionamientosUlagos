...
export const Login = () => {
    ...
    return (
        <div className="w-full flex flex-col items-center justify-center gap-y-8 py-8">
            <form className="flex flex-col items-center gap-y-8 w-full">
                <div className="w-full flex flex-row">
                    <div className="w-[10%] border-[0.5px] border-r-[0px] border-blue-ribbon-600 flex items-center justify-center max-md:w-[15%]">
