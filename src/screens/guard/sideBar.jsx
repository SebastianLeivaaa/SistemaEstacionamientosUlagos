...
export const SideBar = ({ onToggleMenu, handleToggleMenu, userName, userLastNamePat, userLastNameMat, userEmail, handleCurrentPage, currentPage }) => {
    ...
    return (
        <div className={`w-[256px] h-full overflow-y-scroll fixed z-20 flex flex-col bg-white-50 dark:bg-midnight-950 border-r-[1px] border-white-400 dark:border-white-700 gap-y-6 p-3 transition-all duration-300 ease-in-out ${onToggleMenu ? "visible translate-x-0" : "invisible -translate-x-full"}`} ref={sidebarRef}>
