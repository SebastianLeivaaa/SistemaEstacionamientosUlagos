    ...
    return(
        <div className="dark:bg-midnight-950 bg-white-50 shadow-3xl  contrast-[95%] rounded-md p-8 max-md:p-4 w-full flex flex-col gap-y-8 max-md:gap-y-4">
            ...
            <div className="flex flex-row gap-x-8 w-full justify-start max-lg:grid max-lg:grid-cols-4 max-md:grid-cols-2 max-lg:gap-x-2 max-md:gap-x-2 gap-y-3">
                <button onClick={() => {handleCurrentPage('/reserve-parking')}} className='flex flex-col p-2 py-6 max-md:py-2 bg-midnight-800 hover:bg-midnight-900 rounded-md w-full h-full items-center max-md:gap-y-2'>
                    <MdLocalParking className="text-4xl text-white-50 max-sm:text-2xl"/>
                    <h1 className="text-white-50 text-xl font-bold text-center max-lg:text-base max-sm:text-xs">ADMINISTRAR ESTACIONAMIENTOS</h1>
                </button>
                <button onClick={() => {handleCurrentPage('/my-reservations')}} className='flex flex-col p-2 py-6 max-md:py-2 bg-midnight-800 hover:bg-midnight-900 rounded-md w-full h-full items-center max-md:gap-y-2'>
                ...
                <button onClick={() => {handleCurrentPage('/my-vehicles')}} className='flex flex-col p-2 py-6 max-md:py-2 bg-midnight-800 hover:bg-midnight-900 rounded-md w-full h-full items-center max-md:gap-y-2'>
                ...
                <button onClick={logOut} className='flex flex-col p-2 py-6 max-md:py-2 bg-red-500 hover:bg-red-600 rounded-md w-full h-full items-center max-md:gap-y-2'>
